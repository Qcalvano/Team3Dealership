...
public class Car {
    ...
    public static void viewCarInventory (ArrayList<Car> cars) {
        for (Car car : cars) {
            ...
            System.out.println("Availability: " + car.getAvailable());
    ...
    public static void viewFinancingOptions(ArrayList<Car> carList) {
        ...
        do {
            ...
            if (userInput == 0){
                ...
                System.out.println("List price: $" + carPrice);
                System.out.printf("\tMonthly payments for 36 months at 11% interest: $%.2f\n", (carPrice/36) + (carPrice * 0.11));
                System.out.printf("\tMonthly payments for 48 months at 9% interest: $%.2f\n", (carPrice/48) + (carPrice * 0.09));
            }
            else{
