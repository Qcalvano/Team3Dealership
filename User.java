        ...
        do {
            ...
            do {
                ...
                if (yesNoInput.startsWith("y")){
                    ...
                    else if (userInput.equalsIgnoreCase("Manager")){ //FIXME: When choosing manager program doesn't continue.
                                                                                  //HINT: Type a letter and hit enter for it to return to the previous prompt.
                        _typeID = 2;
                        userTypeEntered = true;
                        creationComplete = true;
                    }
    ...
    public static void userMenu (ArrayList<Car> carList, ArrayList<Dealership> dList, ArrayList<User> uList) {
        ...
        do {
            ...
            switch(scnr.next().charAt(0)){
                case '1':
                    Dealership.viewDealerInfo(dList);
                    break;
                case '2':
                ...
                case '4':
                    ...
                    System.out.println("(PROMPT TO CHOOSE A ROLE)");
                    break;
                case '5':
                    exitMenu = true;
                    break;
            ...
            //TODO: Create if else options to add to the menu based on user role...
